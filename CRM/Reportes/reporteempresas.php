...
$pdf->cell(200,20,'Empresas Registradas',0,0,'C');
$pdf->ln(5);
$pdf->setfont('times','I',13);
$pdf->cell(00,25,utf8_decode('Histórico de Empresas Registradas'),0,0,'C');
...
$pdf->Cell(60,10,utf8_decode('Código Empresa'),0,'L');
$pdf->Cell(60,10,utf8_decode('Código Sucursal'),0,0,'L');
$pdf->Cell(80,10,'Marca Empresa',0,0,'L');
$pdf->ln(10);
//Bucle para imprimir los datos
$pdf->setfont('times','',12);
foreach($resp as $columnas=>$fila)
{
	$pdf->Cell(60,10,$fila['cod_empresa'],0,0,'L');
	$pdf->Cell(60,10,$fila['cod_sucursales'],0,0,'L');
	$pdf->Cell(80,10,$fila['marcas'],0,0,'L');
	$pdf->ln(10);
}
//Pie de pagina
$posicionY=(240-$pdf->GetY());
$pdf->ln($posicionY);
$pdf->cell(0,0,'Total de Empresas: '.count($resp),0,1,'R');
