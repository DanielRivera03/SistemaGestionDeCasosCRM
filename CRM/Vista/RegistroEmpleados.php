...
<head>
    ...
    <title>..:: Sistema Gesti&oacute;n de Casos vtiger | Registro Empleados ..::</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Registrar Empleados</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="toggle-right"></i></span></span>Registrar Empleados</h4>
                </div>
                <!-- /Title -->
                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form class="needs-validation" novalidate method="POST" action="../Controlador/cGestionarEmpleados.php?acc=3" autocomplete="off">
                                        <div class="form-row">
                                            <!-- ID -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el ID Empleado <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" name="IDEmpleados" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese ID Empleado..." value="" data-toggle="tooltip-pink" data-placement="top" title="Solo valores n&uacute;mericos" minlength="1" maxlength="6" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el ID Empleado...
                                                </div>
                                                <!-- VALIDO -->
                                            ...
                                            <!-- CODIGO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el c&oacute;digo de empleado <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" minlength="3" maxlength="3" name="CODEmpleados" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese C&oacute;digo de Empleado..." value="" data-toggle="tooltip-pink" data-placement="top" title="Solo valores n&uacute;mericos" minlength="1" maxlength="6" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <!-- NOMBRE -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el nombre del empleado <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" minlength="3" maxlength="50" name="NOMEmpleados" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El Nombre del empleado..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <!-- APELLIDO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el apellido del empleado <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" minlength="3" maxlength="50" name="APEEmpleados" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese el apellido del empleado..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <!-- DUI -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el Dui del empleado <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" minlength="8" maxlength="12" name="DUIEmpleados" data-mask="99999999-9" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese direcci&oacute;n de sucursal..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <!-- TELEFONO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el Tel&eacute;fono del empleado <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" minlength="8" maxlength="9" name="TELEmpleados" data-mask="9999-9999" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese el Tel&eacute;fono del empleado..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-12 mb-10">
                                                <label for="validationCustom01">Ingrese la Direcci&oacute;n del empleado <span class="CampoObligatorio">(*)</span></label></label>
                                                <textarea name="DIREmpleados" minlength="5" maxlength="100" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese la Direcci&oacute;n del empleado..." value="" required></textarea>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                        ...
                                        <button class="btn btn-gradient-primary" type="submit"><i class="fa fa-check"></i> Registrar Empleado</button>
