        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Registrar Vendedores</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form class="needs-validation" novalidate method="POST" action="../Controlador/cGestionarVendedores.php?acc=3" autocomplete="off">
                                        <div class="form-row">
                                            <!-- ID -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el ID Empleado <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" name="IDNVendedor" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese ID Empleado..." value="" data-toggle="tooltip-pink" data-placement="top" title="Solo valores n&uacute;mericos" minlength="1" maxlength="6" required>
                                                <!-- INVALIDO -->
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="text" name="CODIVendedor" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese C&oacute;digo de Empleado..." value="" data-toggle="tooltip-pink" data-placement="top" title="Solo valores n&uacute;mericos" minlength="1" maxlength="6" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el c&oacute;digo de empleado...
                                                </div>
                                                <!-- VALIDO -->
                                                <div class="valid-feedback">
                                                    Campo Completado Exitosamente!...
                                            ...
                                            <!-- TIPO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el tipo de empleado <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" minlength="3" maxlength="20" name="TIPVendedor" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese el tipo de empleado..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor Ingrese el tipo de empleado...<br>
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="text" minlength="3" maxlength="20" name="NOMBREVendedor" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El Nombre del empleado..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-12 mb-10">
                                                <label for="validationCustom01">Ingrese el &aacute;rea del empleado <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" minlength="3" maxlength="20" name="AREAVendedor" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese &aacute;rea de del empleado..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el &aacute;rea del empleado...<br>
                                                    Car&aacute;cteres M&iacute;nimos: 3
                                                    Car&aacute;cteres M&aacute;ximos: 20
                                                </div>
                                                <!-- VALIDO -->
                                        ...
                                        <button class="btn btn-gradient-primary" type="submit"><i class="fa fa-check"></i> Registrar Vendedor</button>
