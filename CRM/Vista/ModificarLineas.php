...
<head>
    ...
    <title>..:: Sistema Gesti&oacute;n de Casos vtiger | Modificar L&iacute;neas ..::</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Modificar L&iacute;neas</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="toggle-right"></i></span></span>Modificar L&iacute;neas</h4>
                </div>
                <!-- /Title -->
                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form class="needs-validation" novalidate method="POST" action="../Controlador/cGestionarLineas.php?acc=9">
                                        <div class="form-row">
                                            <!-- ID -->
                                            <div class="col-md-12 mb-10">
                                                <input type="hidden" name="IDDLineas" class="form-control" id="validationCustom01" value="<?php echo $ID_LineasGestiones; ?>">
                                            </div>


                                            <!-- CODIGO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el c&oacute;digo de L&iacute;nea <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" name="CODDLineas" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese C&oacute;digo de L&iacute;nea..." value="<?php echo $Usuarios->getCodLinea(); ?>" required>
                                                <!-- INVALIDO -->
                                            ...
                                            <!-- TIPO LINEA -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el tipo de L&iacute;nea <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" minlength="3" maxlength="50" name="TIPOSLineas" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El Tipo de L&iacute;nea..." value="<?php echo $Usuarios->getTipoLinea(); ?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                        ...
                                        <button class="btn btn-gradient-primary" type="submit"><i class="fa fa-check"></i> Modificar L&iacute;neas</button>
                                    </form>
                                </div>
                            </div>
            </div>
