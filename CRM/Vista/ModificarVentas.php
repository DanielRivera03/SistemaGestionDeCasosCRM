...
<head>
    ...
    <title>..:: Sistema Gesti&oacute;n de Casos vtiger | Modificar Ventas ..::</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="toggle-right"></i></span></span>Modificar Ventas</h4>
                </div>
                <!-- /Title -->
                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form class="needs-validation" novalidate method="POST" action="../Controlador/cGestionarFacturas.php?acc=9">
                                        <div class="form-row">
                                            <!-- ID -->
                                            <div class="col-md-12 mb-10">
                                                <input type="hidden" name="IDFacturas" class="form-control" id="validationCustom01" value="<?php echo $ID_FacturacionClientes; ?>">
                                            </div>


                                            <!-- CODIGO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el c&oacute;digo de factura</label>
                                                <input type="text" name="CODFacturas" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese C&oacute;digo Factura..." value="<?php echo $Usuarios->getCODFactura(); ?>" required>
                                                <!-- INVALIDO -->
                                            ...
                                            <!-- VALOR DE PAGO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el valor de pago del producto</label>
                                                <input type="text" name="PAGOFacturas" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El Valor de Pago del producto..." value="<?php echo $Usuarios->getPagoFactura(); ?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <!-- MODELO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el modelo de pago</label>
                                                <input type="text" minlength="3" maxlength="50" name="MODELFacturas" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El Modelo de Pago de Producto..." value="<?php echo $Usuarios->getModeloFactura(); ?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <!-- LICENCIA -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">¿Cuenta con Licencia de Producto?</label>
                                                <select class="form-control custom-select" name="LICFacturas" required>
                                                    <option value="<?php echo $Usuarios->getLicenciaFactura(); ?>"><?php echo $Usuarios->getLicenciaFactura(); ?></option>
                                                    <?php
                                                        // SI ESTADO ES SI
                                                        if($Usuarios->getLicenciaFactura() == "Si"){
                                                            echo '<option value="No">No</option>';
                                                        }
                                                        // SI ESTADO ES NO
                                                        if($Usuarios->getLicenciaFactura() == "No"){
                                            ...
                                            <!-- TIPO DE SISTEMA -->
                                            <div class="col-md-12 mb-10">
                                                <label for="validationCustom01">Ingrese el tipo de sistema</label>
                                                <input type="text" minlength="3" maxlength="25" name="TIPSIFacturas" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El Tipo de Sistema..." value="<?php echo $Usuarios->getTipoSIFactura(); ?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                        ...
                                        <button class="btn btn-gradient-primary" type="submit"><i class="fa fa-check"></i> Modificar Venta</button>
                                    </form>
                                </div>
                            </div>
            </div>
