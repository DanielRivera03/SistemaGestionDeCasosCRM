...
<head>
    ...
    <title>Listado de Reportes de Clientes</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Exportar Reportes</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <section class="hk-sec-wrapper">
                            ...
                            en pantalla las diferentes opciones de exportaci&oacute;n de registros,
                            por favor seleccione la que le sea mas conveniente.</p>
                            <div class="row">
                                <div class="col-sm">
