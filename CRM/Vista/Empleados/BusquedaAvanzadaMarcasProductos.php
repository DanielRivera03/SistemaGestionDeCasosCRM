...
<head>
    ...
    <title>..:: Sistema Gesti&oacute;n de Casos vtiger | B&uacute;squeda Avanzada Marcas Productos ..::</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Consultar Marcas Productos</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <section class="hk-sec-wrapper">
                            <h5 class="hk-sec-title">Marcas de Productos Registrados</h5>
                                            ...
                                            <tbody>
                                                <?php 
                                                    while($filas=mysqli_fetch_array($consulta)){
                                                       echo '<tr>';
                                                       echo '<td>'.$filas['id_marca'].'</td>';
                                                       echo '<td>'.$filas['cod_marca'].'</td>';
