...
<head>
    ...
    <title>..:: Sistema Gesti&oacute;n de Casos vtiger | Registro Reportes de Problemas ..::</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    <li class="breadcrumb-item"><a href="../Vista/Empleados/PrincipalEmpleados.php?acc=1">Inicio</a></li>
                    <li class="breadcrumb-item"><a href="#">Reportar Problemas</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Registrar Reporte de Problemas</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="toggle-right"></i></span></span>Registrar Reportes</h4>
                </div>
                <!-- /Title -->
                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form class="needs-validation" novalidate method="POST" action="../Controlador/cGestionarReportesPlataforma.php?acc=3" autocomplete="off">
                                        <div class="form-row">
                                            <!-- ESTADO REPORTE -->
                                            <div class="col-md-12 mb-10">
                                                <input type="hidden" class="form-control" name="ESTReporteriaPlataforma" value="pendiente" required>
                                            </select>
                                                <!-- INVALIDO -->
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="text" name="IDReporteriaPlataforma" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese el Nombre del Reporte..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <select name="CODReporteriaPlataforma" class="form-control prohibido" id="validationCustom01" value="" data-toggle="tooltip-pink" data-placement="top" title="Solo valores n&uacute;mericos" required>
                                                    <option value="<?php echo $_SESSION['vsCodigo'] ?>" selected><?php echo $_SESSION['vsCodigo'] ?></option>
                                                </select>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <!-- NOMBRE DE USUARIO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Nombre de Usuario <span class="CampoObligatorio">(*)</span></label>
                                            ...
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <textarea rows="4" name="DETAPROReporteriaPlataforma" minlength="5" maxlength="1000" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese el Detalle de Problema Reporte..." data-toggle="tooltip-pink" data-placement="top" title="Por favor sea claro y preciso con el detalle del problema" value="" required></textarea>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                        ...
                                        <button class="btn btn-gradient-primary" type="submit"><i class="fa fa-check"></i> Registrar Reporte de Plataforma</button>
