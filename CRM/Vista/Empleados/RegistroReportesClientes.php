        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Registrar Reportes</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
                                    ...
                                    <form class="needs-validation" novalidate method="POST" action="../Controlador/cGestionarReportesClientes.php?acc=3" autocomplete="off">
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <select name="NOMREmpleadoreporteriaClientes" required class="form-control prohibido" data-toggle="tooltip-pink" data-placement="top" title="Su nombre de empleado">
