...
<head>
    ...
    <title>..:: Sistema Gesti&oacute;n de Casos vtiger | Historial Reportes Clientes ..::</title>
                    ...
                    <a class="nav-link dropdown-toggle no-caret" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="media">
                            <div class="media-img-wrap">
                                <div class="avatar">
                                    <img src="../Vista/dist/fotosperfiles/<?php echo $_SESSION['vsFotosPerfilesEm'] ?>" alt="FotoPerfil" class="avatar-img rounded-circle">
                                </div>
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="archive"></i></span></span>Historial Casos de Clientes</h4>
                </div>
                <!-- /Title -->
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <section class="hk-sec-wrapper">
                            <h5 class="hk-sec-title">Historial de casos de clientes registrados</h5>
                            <p class="mb-40">Estimado usuario(a), en esta secci&oacute;n
                            usted podr&aacute; ver el historial simple de casos guardados
                            en la base de datos. Le recordamos que es una visualizaci&oacute;n simple de todos los casos registrados, para m&aacute;s detalles debe dirigirse a la opci&oacute;n de men&uacute; correspondiente.</code></p>
                            <div class="row">
                                <div class="col-sm">
                                    <div class="table-wrap">
                                        <table style="font-size: .8rem !important; font-size: 100%;" id="datable_1" class="table table-hover w-100 display pb-30">
                                                <thead class="thead-dark">
                                                    <tr>
                                                        ...
                                                        <th>Detalle del Caso del Cliente</th>
                                                        <th>Estado</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    ...
                                                    while($filas=mysqli_fetch_array($consulta)){
                                                       echo '<tr>';
                                                       echo '<td>'.$filas['Fecha_Registro_Caso'].'</td>';
                                                       echo '<td>'.$filas['Nombre_cliente'].'</td>';
                                                       echo '<td>'.$filas['Producto'].'</td>';
                                                       echo '<td>'.$filas['Ultima_Actualizacion_Caso'].'</td>';
