...
<head>
    ...
    <title>..:: Sistema Gesti&oacute;n de Casos vtiger | B&uacute;squeda Avanzada Ciudades ..::</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Consultar Ciudades</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <section class="hk-sec-wrapper">
                            <h5 class="hk-sec-title">Ciudades Registradas</h5>
                                            ...
                                            <tbody>
                                                <?php 
                                                    while($filas=mysqli_fetch_array($consulta)){
                                                       echo '<tr>';
                                                       echo '<td>'.$filas['id_ciudad'].'</td>';
                                                       echo '<td>'.$filas['cod_ciudad'].'</td>';
                                                       echo '<td>'.$filas['nombre_ciu'].'</td>';
                                                       echo '</tr>';
                                                    }
                                                ?>
