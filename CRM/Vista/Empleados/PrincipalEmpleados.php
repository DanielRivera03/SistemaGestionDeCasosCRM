<?php
session_start();
require '../../Modelo/mConteosInterfaces.php';
...
<head>
    ...
    <title>..:: Sistema Gesti&oacute;n de Casos vtiger | Principal Empleados ..::</title>
	...
	<!-- vector map CSS -->
    <link href="../../Vista/vendors/vectormap/jquery-jvectormap-2.0.3.css" rel="stylesheet" type="text/css" />
	<link href="../../Vista/vendors/apexcharts/dist/apexcharts.css" rel="stylesheet" type="text/css" />
    <!-- Toggles CSS -->
	...
	<!-- Toastr CSS -->
    <link href="../../Vista/vendors/jquery-toast-plugin/dist/jquery.toast.min.css" rel="stylesheet" type="text/css">
    <!-- Custom CSS -->
...
<body>
	...
	<div class="hk-wrapper hk-vertical-nav">
        ...
        <nav class="navbar navbar-expand-xl navbar-light fixed-top hk-navbar shadow-lg shadow-hover-xl">
            ...
            <a class="navbar-brand font-weight-700" href="../../Vista/Empleados/PrincipalEmpleados.php?acc=1">
                VTiger
            </a>
                        ...
                        <div class="notifications-nicescroll-bar">
                            <a href="javascript:void(0);" class="dropdown-item">
                                <?php
                                    ...
                                    include('NotificacionesUsuariosIndexEmpleados.php');
                                ?>
                            </a>
                        </div>
                    </div>
										...
										<div class="card card-sm">
											<div class="card-body">
												<div class="d-flex justify-content-between mb-5">
													<div>
														<span class="d-block font-15 text-dark font-weight-500">N&uacute;mero de Casos En Proceso</span>
													</div>
													<div>
                                                        <!-- PORCENTAJE -->
														<span class="badge badge-green  badge-sm">Total Casos Activos</span>
													</div>
												</div>
												<div>
													<span class="d-block display-5 text-dark mb-5"><?php echo NumeroCasosClientesActivosRegistrados($cnn5); ?></span>
													<small class="d-block">Casos de Clientes "En Proceso"</small>
												</div>
											</div>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="card card-sm">
											<div class="card-body">
												<div class="d-flex justify-content-between mb-5">
													<div>
														<span class="d-block font-15 text-dark font-weight-500">N&uacute;mero de Casos Pendientes</span>
													</div>
													<div>
                                                        <!-- PORCENTAJE -->
														<span class="badge badge-yellow badge-sm">Requieren de su atenci&oacute;n</span>
													</div>
												</div>
												<div>
													<span class="d-block display-5 text-dark mb-5"><?php echo NumeroCasosClientesPendientesRegistrados($cnn6); ?></span>
													<small class="d-block">Casos de Clientes Pendientes</small>
												</div>
											</div>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="card card-sm">
											<div class="card-body">
												<div class="d-flex justify-content-between mb-5">
													<div>
														<span class="d-block font-15 text-dark font-weight-500">Clientes Registrados</span>
													</div>
													<div>
                                                        <!-- PORCENTAJE -->
														<span class="badge badge-info badge-sm">Fines Estad&iacute;sticos</span>
													</div>
												</div>
												<div>
													<span class="d-block display-5 text-dark mb-5"><?php echo NumeroClientesRegistrados($cnn7); ?></span>
													<small class="d-block">Total de clientes registrados en el sistema</small>
												</div>
											</div>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="card card-sm">
											<div class="card-body">
												<div class="d-flex justify-content-between mb-5">
													<div>
														<span class="d-block font-15 text-dark font-weight-500">Productos Registrados</span>
													</div>
													<div>
                                                        <!-- PORCENTAJE -->
														<span class="badge badge-pink  badge-sm">Fines Estad&iacute;sticos</span>
													</div>
												</div>
												<div>
													<span class="d-block display-5 text-dark mb-5"><?php echo NumeroProductosRegistrados($cnn8); ?></span>
													<small class="d-block">Total de productos registrados en el sistema</small>
												</div>
											</div>
										</div>
									</div>	
	...
	<script src="../../Vista/vendors/waypoints/lib/jquery.waypoints.min.js"></script>
	<script src="../../Vista/vendors/jquery.counterup/jquery.counterup.min.js"></script>
	
	<!-- Morris Charts JavaScript -->
    <script src="../../Vista/vendors/raphael/raphael.min.js"></script>
    <script src="../../Vista/vendors/morris.js/morris.min.js"></script>
	
	<!-- EChartJS JavaScript -->
    <script src="../../Vista/vendors/echarts/dist/echarts-en.min.js"></script>
    
	<!-- Sparkline JavaScript -->
    <script src="../../Vista/vendors/jquery.sparkline/dist/jquery.sparkline.min.js"></script>
	
	<!-- Vector Maps JavaScript -->
    <script src="../../Vista/vendors/vectormap/jquery-jvectormap-2.0.3.min.js"></script>
    <script src="../../Vista/vendors/vectormap/jquery-jvectormap-world-mill-en.js"></script>
    <script src="../../Vista/dist/js/vectormap-data.js"></script>
	...
	<!-- Toastr JS -->
    <script src="../../Vista/vendors/jquery-toast-plugin/dist/jquery.toast.min.js"></script>
    
    <!-- Init JavaScript -->
    <script src="../../Vista/dist/js/init.js"></script>
	<script src="../../Vista/dist/js/dashboard-data.js"></script>
