            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-xl-7 pa-0">
                        <div class="auth-form-wrap py-xl-0 py-20">
                            <div class="auth-form w-xxl-55 w-xl-75 w-sm-90 w-xs-100">
                                <h2 class="msjPrincipal">Lo Sentimos, Ha Ocurrido Un Error A La Hora De Iniciar Sesi&oacute;n</h2>
                                <img class="msjError" src="../../Vista/dist/img/ErrorMsj.png">
                                <h4 class="msjSecundario">Por favor tome en cuenta:</h4>
                                <h5 class="msjUsuarios">* Ingreso un nombre de usuario y/o contrase&ntilde;a inv&aacute;lido</h4>
                                <h5 class="msjUsuarios">** No tiene los suficientes privilegios para acceder a esta &aacute;rea</h5>
                                <a href="../../Controlador/ControlLoginEmpleados.php?acc=1"><button class="btn btn-primary btn-block espaciado-btn" type="submit"><i class="fa fa-plus"></i> Intentar Otra Vez</button></a>
                            </div>
                        </div>
                    </div>
                </div>
