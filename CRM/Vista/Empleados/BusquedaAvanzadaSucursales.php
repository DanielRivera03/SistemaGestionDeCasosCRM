...
<head>
    ...
    <title>..:: Sistema Gesti&oacute;n de Casos vtiger | B&uacute;squeda Avanzada Sucursales ..::</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Consultar Sucursales</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <section class="hk-sec-wrapper">
                            <h5 class="hk-sec-title">Sucursales Registradas</h5>
                                    ...
                                    <div class="table-wrap">
                                        <table id="datable_1" class="table table-hover w-100 display pb-30">
                                            <thead class="thead-dark">
                                                <tr>
                                                    <th>ID Sucursal</th>
                                                    <th>C&oacute;digo Sucursal</th>
                                                    <th>Nombre Sucursal</th>
                                                    <th>Tel&eacute;fono Sucursal</th>
                                                    <th>Direcci&oacute;n Sucursal</th>
                                                    <th>Correo Sucursal</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php 
                                                    while($filas=mysqli_fetch_array($consulta)){
                                                       echo '<tr>';
                                                       echo '<td>'.$filas['id_sucursal'].'</td>';
                                                       echo '<td>'.$filas['cod_sucursal'].'</td>';
                                                       echo '<td>'.$filas['nombre_suc'].'</td>';
