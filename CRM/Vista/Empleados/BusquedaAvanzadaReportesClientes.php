...
<head>
    ...
    <title>..:: Sistema Gesti&oacute;n de Casos vtiger | B&uacute;squeda Avanzada Reportes Clientes ..::</title>
    ...
    <!-- Data Table CSS -->
    <link href="./Vista/vendors/datatables.net-dt/css/jquery.dataTables.min.css" rel="stylesheet" type="text/css" />
    <link href="./Vista/vendors/datatables.net-responsive-dt/css/responsive.dataTables.min.css" rel="stylesheet" type="text/css" />
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Consultar Reportes</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>Listado Completo de Registros</h4>
                </div>
                <!-- /Title -->
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <section class="hk-sec-wrapper">
                            <h5 class="hk-sec-title">Reportes de Clientes Registrados</h5>
                            ...
                            en el mismo, usted podr&aacute; realizar una b&uacute;squeda avanzada seleccionando una columna con la que usted desee buscar el registro.</p>
                            <div class="row">
                                <div class="col-sm">
                                            ...
                                            <tbody>
                                                <?php 
                                                    while($filas=mysqli_fetch_array($consulta)){
                                                       ...
                                                       echo '<td>'.$filas['Detalle_de_problema'].'</td>';
                                                        // URGENCIA
                                                       if($filas['Urgencia'] == "Estandar"){
                                                        echo '<td><span class="badge badge-green">'.$filas['Urgencia'].'</span></td>';
                                                       }else if($filas['Urgencia'] == "Media"){
                                                        echo '<td><span class="badge badge-yellow">'.$filas['Urgencia'].'</span></td>';
                                                       }else if ($filas['Urgencia'] == "Alta"){
                                                        echo '<td><span class="badge badge-danger">'.$filas['Urgencia'].'</span></td>';
                                                       }

                                                       // ESTADO DE REPORTE
                                                       if($filas['Estado_de_reporte'] == "pendiente"){
                                                        echo '<td><span class="badge badge-danger">'.$filas['Estado_de_reporte'].'</span></td>';
                                                        }else if($filas['Estado_de_reporte'] == "en proceso"){
                                                            echo '<td><span class="badge badge-green">'.$filas['Estado_de_reporte'].'</span></td>';
                                                        }else if($filas['Estado_de_reporte'] == "cerrado"){
                                                            echo '<td><span class="badge badge-dark">'.$filas['Estado_de_reporte'].'</span></td>';
                                                        }
                                                       echo '</tr>';
                                                    }
                                                ?>
