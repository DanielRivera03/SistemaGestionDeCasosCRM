...
<head>
    ...
    <title>..:: Sistema Gesti&oacute;n de Casos vtiger | Gestionar Clientes ..::</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Gestionar Clientes</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="archive"></i></span></span>Gestionar Clientes</h4>
                </div>
                <!-- /Title -->
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <div class="table-wrap">
                                        <table style="font-size: .85rem !important;" id="datable_1" class="table table-hover w-100 display pb-30">
                                                ...
                                                <tbody>
                                                    ...
                                                    while($filas=mysqli_fetch_array($consulta)){
                                                       ...
                                                       if($filas['estado']=="I"){
                                                            echo '<td> <span class="badge badge-orange">Inactivo</span></td>';
                                                       }else if($filas['estado']=="A"){
                                                            echo '<td> <span class="badge badge-info">Activo</span></td>';
                                                       }
                                                       if($filas['EstadoFactura']=="Moroso"){
                                                        echo '<td> <span class="badge badge-danger">'.$filas['EstadoFactura'].'</span></td>';
                                                       }else{
                                                        echo '<td> <span class="badge badge-green">'.$filas['EstadoFactura'].'</span></td>';
                                                       }
                                                       echo '<td><a href="cGestionarClientes.php?acc=8&cod='.$filas['id_cliente'].'"><i class="fa fa-edit edit-table modificar" data-toggle="tooltip-neon" data-placement="top" title="Modificar"></i></a></td>';
                                                       # CONTROL ELIMINAR REGISTROS
                                                       $ConfirmarDepuracion="return confirm('¿Desea realmente eliminar este usuario?');";
                                                       echo '<td><a href="cGestionarClientes.php?acc=7&cod='.$filas['id_cliente'].'"><i class="fa fa-trash-o edit-table eliminar" data-toggle="tooltip-danger" data-placement="top" title="Eliminar" onclick="'.$ConfirmarDepuracion.'"></i></a></td>';
                                                       echo '</tr>';
                                                    }
                                                ?>
                                                </tbody>
