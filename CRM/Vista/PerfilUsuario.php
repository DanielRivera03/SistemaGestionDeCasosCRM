									...
									<div class="col-lg-6">
										<div class="media align-items-center">
											...
											<div class="media-body">
												...
												<div class="font-14 text-white"><span class="mr-5"><span class="font-weight-500 pr-5">Tipo de Usuario:</span><span class="mr-5"> <span class="badge badge-danger"><?php echo $_SESSION['vsTipo'] ?></span></span></span>C&oacute;digo &Uacute;nico de Usuario: <span class="badge badge-pink"><?php echo $_SESSION['vsCodigo']?></span><span><span class="font-weight-500 pr-5"></span><span></span></span></div>
											</div>
										</div>
									</div>
								</div>
                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form class="needs-validation" novalidate method="POST" action="../Controlador/cUsuariosAdministradores.php?acc=9" enctype="multipart/form-data">
                                        <div class="form-row">
                                            <!-- ID -->
                                            <div class="col-md-12 mb-10">
                                                <input type="hidden" class="form-control custom-select" name="IdAd" value="<?php echo $_SESSION['vsCodigo']?>" required>
                                            ...
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">C&oacute;digo General Usuario <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" name="CodAd" class="form-control prohibido" id="validationCustom01" placeholder="" value="<?php echo $_SESSION['vsCodigoUs']?>" disabled>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="text" name="NomAd" class="form-control" id="validationCustom01" placeholder="" value="<?php echo $_SESSION['vsUsuario']?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <!-- CONTRASEÑA -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Contrase&ntilde;a de Usuario <span class="CampoObligatorio">(*)</span></label>
                                                <input type="password" name="PassAd" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese Contrase&ntilde;a Usuario..." minlength="5" maxlength="15" data-toggle="tooltip-pink" data-placement="top" title="M&iacute;nimo 5 caracteres" value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <!-- ESTADO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Estado de Usuario <span class="CampoObligatorio">(*)</span></label>
                                                <select class="form-control custom-select prohibido" name="EstadoAd" required>
                                            ...
                                            <!-- TIPO USUARIO -->
                                            <div class="col-md-12 mb-10">
                                                <label for="validationCustom01">Tipo de Usuario Registrado <span class="CampoObligatorio">(*)</span></label>
                                                <select class="form-control custom-select prohibido" name="TipoUAd" required>
                                            ...
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="file" id="input-file-now" name="FotoPerfilAdmins" class="dropify"  data-max-file-size="2M" accept="image/x-png,image/jpeg" data-toggle="tooltip-pink" data-placement="top" title="Campo No Obligatorio">
                                            ...
                                            <div class="col-md-12 mb-10">
                                                <input type="hidden" name="ValidarFotoExistente" value="<?php echo $_SESSION['vsFotosPerfilesUs'] ?>">
                                            </div>
