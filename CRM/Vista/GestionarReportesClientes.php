        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Gestionar Casos Clientes</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="archive"></i></span></span>Gestionar Casos de Clientes</h4>
                </div>
                <!-- /Title -->
                                        ...
                                        <table id="datable_1" class="table table-hover w-100 display pb-30">
                                                ...
                                                <tbody>
                                                    ...
                                                    while($filas=mysqli_fetch_array($consulta)){
                                                       ...
                                                       echo '<td><a href="cGestionarReportesClientes.php?acc=8&cod='.$filas['Id_reporte'].'"><i class="fa fa-edit edit-table modificar" data-toggle="tooltip-neon" data-placement="top" title="Modificar"></i></a></td>';
                                                       # CONTROL ELIMINAR REGISTROS
                                                       $ConfirmarDepuracion="return confirm('¿Desea realmente eliminar este reporte del sistema?');";
                                                       echo '<td><a href="cGestionarReportesClientes.php?acc=7&cod='.$filas['Id_reporte'].'"><i class="fa fa-trash-o edit-table eliminar" data-toggle="tooltip-danger" data-placement="top" title="Eliminar" onclick="'.$ConfirmarDepuracion.'"></i></a></td>';
                                                       echo '</tr>';
                                                    }
                                                ?>
                                                </tbody>
