...
<head>
    ...
    <title>..:: Sistema Gesti&oacute;n de Casos vtiger | Gestionar Productos ..::</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="archive"></i></span></span>Gestionar Productos</h4>
                </div>
                <!-- /Title -->
                                        ...
                                        <table id="datable_1" class="table table-hover w-100 display pb-30">
                                                ...
                                                <tbody>
                                                    ...
                                                    while($filas=mysqli_fetch_array($consulta)){
                                                        echo '<tr>';
                                                        echo '<th scope="row">'.$filas['id_producto'].'</th>';
                                                        ...
                                                        if($filas['garantia']=="A"){
                                                            echo '<td><span class="badge badge-info">Activa</span></td>';
                                                        }else if($filas['garantia']=="I"){
                                                            echo '<td><span class="badge badge-orange">Inactiva</span></td>';
                                                        }
                                                        # CONTROL ELIMINAR REGISTROS
                                                       $ConfirmarDepuracion="return confirm('¿Desea realmente eliminar este producto?');";
                                                       # CONTROL MODIFICAR REGISTROS
                                                       echo '<td><a href="cGestionarProductos.php?acc=8&cod='.$filas['id_producto'].'"><i class="fa fa-edit edit-table modificar" data-toggle="tooltip-neon" data-placement="top" title="Modificar"></i></a></td>';
                                                       echo '<td><a href="cGestionarProductos.php?acc=7&cod='.$filas['id_producto'].'" data-toggle="tooltip-danger" data-placement="top" title="Eliminar"> <i class="fa fa-trash-o edit-table eliminar" onclick="'.$ConfirmarDepuracion.'"></i></a></td>';
