...
<head>
    ...
    <title>..:: Sistema Gesti&oacute;n de Casos vtiger | Gestionar Ventas ..::</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="archive"></i></span></span>Gestionar Ventas</h4>
                </div>
                <!-- /Title -->
                                        ...
                                        <table id="datable_1" class="table table-hover w-100 display pb-30">
                                                ...
                                                <tbody>
                                                    ...
                                                    while($filas=mysqli_fetch_array($consulta)){
                                                       echo '<tr>';
                                                       echo '<th scope="row">'.$filas['id_factura'].'</th>';
                                                       echo '<td>'.$filas['cod_factura'].'</td>';
                                                       echo '<td>'.$filas['pago'].'</td>';
                                                       echo '<td>'.$filas['modelo'].'</td>';
                                                       echo '<td>'.$filas['licencia'].'</td>';
                                                       echo '<td>'.$filas['tipoSI'].'</td>';
                                                       echo '<td><a href="cGestionarFacturas.php?acc=8&cod='.$filas['id_factura'].'"><i class="fa fa-edit edit-table modificar" data-toggle="tooltip-neon" data-placement="top" title="Modificar"></i></a></td>';
                                                       # CONTROL ELIMINAR REGISTROS
                                                       $ConfirmarDepuracion="return confirm('¿Desea realmente eliminar este registro de venta?');";
                                                       echo '<td><a href="cGestionarFacturas.php?acc=7&cod='.$filas['id_factura'].'"><i class="fa fa-trash-o edit-table eliminar" onclick="'.$ConfirmarDepuracion.'" data-toggle="tooltip-danger" data-placement="top" title="Eliminar"></i></a></td>';
                                                       echo '</tr>';
                                                    }
                                                ?>
                                                </tbody>
