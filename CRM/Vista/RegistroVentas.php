...
<head>
    ...
    <title>..:: Sistema Gesti&oacute;n de Casos vtiger | Registro Ventas ..::</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="toggle-right"></i></span></span>Registrar Ventas</h4>
                </div>
                <!-- /Title -->
                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form class="needs-validation" novalidate method="POST" action="../Controlador/cGestionarFacturas.php?acc=3" autocomplete="off">
                                        <div class="form-row">
                                            <!-- ID -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el ID Venta <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" name="IDFacturas" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese ID Venta..." value="" data-toggle="tooltip-pink" data-placement="top" title="Solo valores n&uacute;mericos" minlength="1" maxlength="6" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el ID Venta...
                                                </div>
                                                <!-- VALIDO -->
                                            ...
                                            <!-- CODIGO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el c&oacute;digo de factura <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" name="CODFacturas" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese C&oacute;digo Factura..." value="" data-toggle="tooltip-pink" data-placement="top" title="Solo valores n&uacute;mericos" minlength="1" maxlength="6" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el c&oacute;digo de factura...
                                                </div>
                                                <!-- VALIDO -->
                                                <div class="valid-feedback">
                                                    Campo Completado Exitosamente!...
                                            ...
                                            <!-- VALOR DE PAGO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el valor de pago del producto <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" name="PAGOFacturas" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El Valor de Pago del producto..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el valor de pago del producto...
                                                </div>
                                                <!-- VALIDO -->
                                                <div class="valid-feedback">
                                                    Campo Completado Exitosamente!...
                                            ...
                                            <!-- MODELO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el modelo de pago <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" minlength="3" maxlength="50" name="MODELFacturas" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El Modelo de Pago de Producto..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el modelo de pago de producto...<br>
                                            ...
                                            <!-- LICENCIA -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">¿Cuenta con Licencia de Producto? <span class="CampoObligatorio">(*)</span></label>
                                                <select class="form-control custom-select" name="LICFacturas" required>
                                            ...
                                            <!-- TIPO DE SISTEMA -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el tipo de sistema <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" minlength="3" maxlength="25" name="TIPSIFacturas" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El Tipo de Sistema..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el tipo de sistema...<br>
                                                    Car&aacute;cteres M&iacute;nimos: 3
                                        ...
                                        <button class="btn btn-gradient-primary" type="submit"><i class="fa fa-check"></i> Registrar Venta</button>
