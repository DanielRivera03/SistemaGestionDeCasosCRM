...
<head>
    ...
    <title>..:: Sistema Gesti&oacute;n de Casos vtiger | B&uacute;squeda Avanzada Reportes Plataforma ..::</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Consultar Reportes Plataforma</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <section class="hk-sec-wrapper">
                            <h5 class="hk-sec-title">Reportes de Plataforma Registrados</h5>
                                            ...
                                            <tbody>
                                                <?php 
                                                    while($filas=mysqli_fetch_array($consulta)){
                                                       echo '<tr>';
                                                       echo '<td>'.$filas['Id_reporte'].'</td>';
                                                       echo '<td>'.$filas['DetallesReporte'].'</td>';
                                                       echo '<td>'.$filas['Comentarios_Finales'].'</td>';
                                                        // URGENCIA
                                                       ...
                                                       // ESTADO DE REPORTE
                                                       if($filas['EstadoReporte'] == "pendiente"){
                                                        echo '<td><span class="badge badge-orange">'.$filas['EstadoReporte'].'</span></td>';
                                                        }else if($filas['EstadoReporte'] == "en proceso"){
                                                            echo '<td><span class="badge badge-green">'.$filas['EstadoReporte'].'</span></td>';
                                                        }else if($filas['EstadoReporte'] == "cerrado"){
                                                            echo '<td><span class="badge badge-dark">'.$filas['EstadoReporte'].'</span></td>';
                                                        }
                                                       echo '</tr>';
                                                    }
                                                ?>
