...
<head>
    ...
    <title>..:: Sistema Gesti&oacute;n de Casos vtiger | Gestionar Empleados ..::</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="archive"></i></span></span>Gestionar Empleados</h4>
                </div>
                <!-- /Title -->
                                        ...
                                        <table id="datable_1" class="table table-hover w-100 display pb-30">
                                                ...
                                                <tbody>
                                                    ...
                                                    while($filas=mysqli_fetch_array($consulta)){
                                                       ...
                                                       echo '<td>'.$filas['cod_empl'].'</td>';
                                                       echo '<td>'.$filas['nombre'].'</td>';
                                                       echo '<td>'.$filas['apellido'].'</td>';
                                                       echo '<td>'.$filas['dui'].'</td>';
                                                       echo '<td>'.$filas['telefono'].'</td>';
                                                       echo '<td>'.$filas['direccion'].'</td>';
                                                       echo '<td><a href="cGestionarEmpleados.php?acc=8&cod='.$filas['id_empleado'].'"><i class="fa fa-edit edit-table modificar" data-toggle="tooltip-neon" data-placement="top" title="Modificar"></i></a></td>';
                                                       # CONTROL ELIMINAR REGISTROS
                                                       $ConfirmarDepuracion="return confirm('¿Desea realmente eliminar este empleado?');";
                                                       echo '<td><a href="cGestionarEmpleados.php?acc=7&cod='.$filas['id_empleado'].'"><i class="fa fa-trash-o edit-table eliminar" data-toggle="tooltip-danger" data-placement="top" title="Eliminar" onclick="'.$ConfirmarDepuracion.'"></i></a></td>';
                                                       echo '</tr>';
                                                    }
                                                ?>
                                                </tbody>
