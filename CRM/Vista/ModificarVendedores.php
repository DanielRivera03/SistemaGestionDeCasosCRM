...
<head>
    ...
    <title>..:: Sistema Gesti&oacute;n de Casos vtiger | Modificar Vendedores ..::</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Modificar Vendedores</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="toggle-right"></i></span></span>Modificar Vendedores</h4>
                </div>
                <!-- /Title -->
                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form class="needs-validation" novalidate method="POST" action="../Controlador/cGestionarVendedores.php?acc=9">
                                        <div class="form-row">
                                            <!-- ID -->
                                            <div class="col-md-12 mb-10">
                                                
                                                <input type="hidden" name="IDVendedor" class="form-control" id="validationCustom01" value="<?php echo $ID_Vendedores; ?>">
                                            </div>
                                            

                                            <!-- CODIGO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el c&oacute;digo del Vendedor <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" name="CODIVendedor" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese C&oacute;digo Vendedor..." value="<?php echo $Usuarios->getCODVendedor(); ?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el c&oacute;digo del vendedor...
                                                </div>
                                                <!-- VALIDO -->
                                            ...
                                            <!-- TIPO DE VENDEDOR -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el nombre del vendedor <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" minlength="2" maxlength="20" name="TIPVendedor" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El Nombre del vendedor..." value="<?php echo $Usuarios->getTipoVendedor(); ?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el nombre del vendedor...<br>
                                            ...
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el nombre del vendedor <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" minlength="5" maxlength="20" name="NOMBREVendedor" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El nombre del vendedor..." value="<?php echo $Usuarios->getNombreVendedor(); ?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el nombre del vendedor...<br>
                                            ...
                                            <!-- AREA DE VENDEDOR -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el area del vendedor <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" minlength="2" maxlength="20" name="AREAVendedor" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El area del vendedor..." value="<?php echo $Usuarios->getAreaVendedor(); ?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el area del vendedor...<br>
                                                    Car&aacute;cteres M&iacute;nimos: 2
                                                    Car&aacute;cteres M&aacute;ximos: 20
                                                </div>
                                                <!-- VALIDO -->
                                        ...
                                        <button class="btn btn-gradient-primary" type="submit"><i class="fa fa-check"></i> Modificar Vendedor</button>
                                    </form>
                                </div>
                            </div>
            </div>
