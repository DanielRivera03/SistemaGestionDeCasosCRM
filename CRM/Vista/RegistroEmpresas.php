...
<head>
    ...
    <title>..:: Sistema Gesti&oacute;n de Casos vtiger | Registro Empresas ..::</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="toggle-right"></i></span></span>Registrar Empresas</h4>
                </div>
                <!-- /Title -->
                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form class="needs-validation" novalidate method="POST" action="../Controlador/cGestionarEmpresas.php?acc=3" autocomplete="off">
                                        <div class="form-row">
                                            <!-- ID -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el ID Empresa <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" name="IDEmpresa" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese ID Empresa..." value="" data-toggle="tooltip-pink" data-placement="top" title="Solo valores n&uacute;mericos" minlength="1" maxlength="6" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el ID Empresa...
                                                </div>
                                                <!-- VALIDO -->
                                            ...
                                            <!-- CODIGO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el c&oacute;digo de Empresa <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" minlength="3" maxlength="3" name="CODEmpresa" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese C&oacute;digo de Empresa..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el c&oacute;digo de Empresa...<br>
                                            ...
                                            <!-- CODIGO SUCURSAL -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el c&oacute;digo de Sucursal <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" minlength="3" maxlength="3" name="CODSUCREmpresa" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese C&oacute;digo de Sucursal..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el c&oacute;digo de Sucursal...<br>
                                                    Car&aacute;cteres M&iacute;nimos: 3
                                                    Car&aacute;cteres M&aacute;ximos: 3
                                                </div>
                                                <!-- VALIDO -->
                                            ...
                                            <!-- MARCAS -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el rubro / marca de empresa <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" minlength="3" maxlength="50" name="NOMBMARCASEmpresa" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese el rubro / marca de empresa..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor Ingrese el rubro / marca de empresa...<br>
                                                    Car&aacute;cteres M&iacute;nimos: 3
                                        ...
                                        <button class="btn btn-gradient-primary" type="submit"><i class="fa fa-check"></i> Registrar Empresa</button>
