...
<head>
    ...
    <title>..:: Sistema Gesti&oacute;n de Casos vtiger | Modificar Marcas ..::</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Modificar Marcas</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="toggle-right"></i></span></span>Modificar Marcas</h4>
                </div>
                <!-- /Title -->
                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form class="needs-validation" novalidate method="POST" action="../Controlador/cGestionarMarcas.php?acc=9">
                                        <div class="form-row">
                                            <!-- ID -->
                                            <div class="col-md-12 mb-10">
                                                
                                                <input type="hidden" name="IDMarcas" class="form-control" id="validationCustom01" value="<?php echo $ID_Marcas; ?>">
                                            </div>
                                            

                                            <!-- CODIGO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el c&oacute;digo de la Marca <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" name="CODIGOMarcas" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese C&oacute;digo Marca..." value="<?php echo $Usuarios->getCodigoMarcas(); ?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el c&oacute;digo de la marca...
                                                </div>
                                                <!-- VALIDO -->
                                            ...
                                            <!-- NOMBRE DE MARCA -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el nombre de la marca <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" minlength="2" maxlength="50" name="NOMBREMarcas" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El Nombre de la Marca..." value="<?php echo $Usuarios->getDetalleMarcas(); ?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el nombre de la marca...<br>
                                            ...
                                            <!-- TIPO DE MARCA -->
                                            <div class="col-md-12 mb-10">
                                                <label for="validationCustom01">Ingrese el tipo de la marca <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" minlength="2" maxlength="50" name="TIPOMarcas" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El Apellido de la Marca..." value="<?php echo $Usuarios->getTipoMarcas(); ?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el nombre de la marca...<br>
                                                    Car&aacute;cteres M&iacute;nimos: 2
                                        ...
                                        <button class="btn btn-gradient-primary" type="submit"><i class="fa fa-check"></i> Modificar Marca</button>
                                    </form>
                                </div>
                            </div>
            </div>
