...
<head>
    ...
    <title>..:: Sistema Gesti&oacute;n de Casos vtiger | Consulta Vendedores ..::</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Consultar Vendedores</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="archive"></i></span></span>Gestionar Vendedores</h4>
                </div>
                <!-- /Title -->
                                        ...
                                        <table id="datable_1" class="table table-hover w-100 display pb-30">
                                                ...
                                                <tbody>
                                                    ...
                                                    while($filas=mysqli_fetch_array($consulta)){
                                                       echo '<tr>';
                                                       echo '<th scope="row">'.$filas['id_empleado'].'</th>';
                                                       echo '<td>'.$filas['cod_empleado'].'</td>';
                                                       echo '<td>'.$filas['tipo'].'</td>';
                                                       echo '<td>'.$filas['nombre'].'</td>';
                                                       echo '<td>'.$filas['area'].'</td>';
                                                       echo '<td><a href="cGestionarVendedores.php?acc=8&cod='.$filas['id_empleado'].'"><i class="fa fa-edit edit-table modificar" data-toggle="tooltip-neon" data-placement="top" title="Modificar"></i></a></td>';
                                                        $ConfirmarDepuracion="return confirm('¿Desea realmente eliminar este vendedor?');";
                                                       echo '<td><a href="cGestionarVendedores.php?acc=7&cod='.$filas['id_empleado'].'"><i class="fa fa-trash-o edit-table eliminar" onclick="'.$ConfirmarDepuracion.'" data-toggle="tooltip-danger" data-placement="top" title="Eliminar"></i></a></td>';
                                                       echo '</tr>';
                                                    }
                                                ?>
                                                </tbody>
