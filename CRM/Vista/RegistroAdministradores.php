        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="toggle-right"></i></span></span>Registrar Usuarios Administradores</h4>
                </div>
                <!-- /Title -->
                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form class="needs-validation" novalidate method="POST" action="../Controlador/cUsuariosAdministradores.php?acc=3" enctype="multipart/form-data" autocomplete="off">
                                        <div class="form-row">
                                            <!-- ID -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el ID Usuario <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" name="IdAd" class="form-control" id="validationCustom01" minlength="1" maxlength="6" placeholder="Por favor Ingrese ID Usuario..." value="" data-toggle="tooltip-pink" data-placement="top" title="Solo valores n&uacute;mericos" required>
                                                <!-- INVALIDO -->
                                            ...
                                            <!-- ESTADO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Estado Usuario <span class="CampoObligatorio">(*)</span></label></label>
                                            ...
                                            <!-- TIPO USUARIO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Tipo de Usuario <span class="CampoObligatorio">(*)</span></label></label>
