...
<head>
    ...
    <title>..:: Clientes Registrados | vtiger ..::</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Exportar Clientes</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <section class="hk-sec-wrapper">
                            <h5 class="hk-sec-title">Usuarios Registrados Privilegio: Usuarios</h5>
                                            ...
                                            <thead class="thead-light">
                                                ...
                                                <?php 
                                                    while($filas=mysqli_fetch_array($consulta)){
                                                       echo '<tr>';
                                                       echo '<th scope="row">'.$filas['id_cliente'].'</th>';
                                                       echo '<td>'.$filas['cod_cliente'].'</td>';
