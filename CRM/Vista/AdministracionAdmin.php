										...
										<div class="card card-sm">
											<div class="card-body">
												<div class="d-flex justify-content-between mb-5">
													<div>
														<span class="d-block font-15 text-dark font-weight-500">N&uacute;mero de Administradores</span>
													</div>
													<div>
                                                        <!-- PORCENTAJE -->
												...
												<div>
													<span class="d-block display-5 text-dark mb-5"><?php echo NumeroAdministradoresRegistrados($cnn1); ?></span>
													<small class="d-block">Administradores Registrados</small>
												</div>
											</div>
										</div>
									</div>
