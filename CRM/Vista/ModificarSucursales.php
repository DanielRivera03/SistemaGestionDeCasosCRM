        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Modificar Sucursales</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="toggle-right"></i></span></span>Modificar Sucursales</h4>
                </div>
                <!-- /Title -->
                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form class="needs-validation" novalidate method="POST" action="../Controlador/cGestionarSucursales.php?acc=9">
                                        <div class="form-row">
                                            <!-- ID -->
                                            <div class="col-md-12 mb-10">
                                                
                                                <input type="hidden" name="IDSucursales" class="form-control" id="validationCustom01" value="<?php echo $Id_Sucursales; ?>">
                                            </div>
                                            

                                            <!-- CODIGO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el c&oacute;digo de Sucursal <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" name="CODISucursales" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese C&oacute;digo Sucursal..." value="<?php echo $Usuarios->getCODSucursales(); ?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el c&oacute;digo del sucursales...
                                                </div>
                                                <!-- VALIDO -->
                                            ...
                                            <!-- NOMBRE DE SUCURSAL -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el nombre del sucursales <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" minlength="5" maxlength="50" name="NOMBRSucursales" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El Nombre del sucursal..." value="<?php echo $Usuarios->getNOMBRESucursales(); ?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el nombre del sucursales...<br>
                                            ...
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el telefono del sucursal <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" minlength="9" maxlength="9" name="TELESucursales" class="form-control" id="validationCustom01" data-mask="9999-9999" placeholder="Por favor Ingrese El telefono del sucursales..." value="<?php echo $Usuarios->getTELEFONOSucursales(); ?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el telefono del sucursales...<br>
                                                    Car&aacute;cteres M&iacute;nimos: 9
                                            ...
                                            <!-- DIRRECCION DE SUCURSAL -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el direcci&oacute; del sucursal <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" minlength="5" maxlength="50" name="DIRESucursales" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El direcci&oacute;n del sucursales..." value="<?php echo $Usuarios->getDIRECCIONSucursales(); ?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese la direcci&oacute;n de la sucursal...<br>
                                                    Car&aacute;cteres M&iacute;nimos: 5
                                                    Car&aacute;cteres M&aacute;ximos: 50
                                                </div>
                                                <!-- VALIDO -->
                                            ...
                                            <!-- CORREO DE SUCURSAL -->
                                            <div class="col-md-12 mb-10">
                                                <label for="validationCustom01">Ingrese el correo de la sucursal <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" minlength="8" maxlength="50" name="CORRSucursales" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El correo de la sucursal..." value="<?php echo $Usuarios->getCORREOSucursales(); ?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el tel&eacute;fono de la sucursal..<br>
                                                    Car&aacute;cteres M&iacute;nimos: 5
                                                    Car&aacute;cteres M&aacute;ximos: 50
                                                </div>
                                                <!-- VALIDO -->
                                        ...
                                        <button class="btn btn-gradient-primary" type="submit"><i class="fa fa-check"></i> Modificar Sucursal</button>
                                    </form>
                                </div>
                            </div>
            </div>
