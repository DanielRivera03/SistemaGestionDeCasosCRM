                                    ...
                                    <form class="needs-validation" novalidate method="POST" action="../Controlador/cGestionarClientes.php?acc=9">
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="text" name="CodClientes" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese C&oacute;digo Cliente..." value="<?php echo $Usuarios->getCodClientesGestiones(); ?>" required>
                                                <!-- INVALIDO -->
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="text" minlength="8" maxlength="9" name="TelClientes" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El Tel&eacute;fono del cliente..." data-mask="9999-9999" value="<?php echo $Usuarios->getTelefonoClientesGestiones(); ?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
