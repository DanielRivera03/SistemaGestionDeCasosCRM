...
<head>
    ...
    <title>..:: Sistema Gesti&oacute;n de Casos vtiger | Registro Marca Productos ..::</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item"><a href="#">Marcas Productos</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Registrar Marca Productos</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="toggle-right"></i></span></span>Registrar Marca Productos</h4>
                </div>
                <!-- /Title -->
                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form class="needs-validation" novalidate method="POST" action="../Controlador/cGestionarMarcas.php?acc=3" autocomplete="off">
                                        <div class="form-row">
                                            <!-- ID -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el ID Marca Producto <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" name="IDMarcas" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese ID Marca Producto..." value="" data-toggle="tooltip-pink" data-placement="top" title="Solo valores n&uacute;mericos"minlength="1" maxlength="6" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el ID Marca Producto...
                                                </div>
                                                <!-- VALIDO -->
                                            ...
                                            <!-- CODIGO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el c&oacute;digo de marca producto <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" name="CODIGOMarcas" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese C&oacute;digo Marca Producto..." value="" data-toggle="tooltip-pink" data-placement="top" title="Solo valores n&uacute;mericos" minlength="1" maxlength="6" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el c&oacute;digo de marca producto...
                                                </div>
                                                <!-- VALIDO -->
                                                <div class="valid-feedback">
                                                    Campo Completado Exitosamente!...
                                            ...
                                            <!-- MARCA DE PRODUCTO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el nombre de la marca del producto <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" minlength="3" maxlength="50" name="NOMBREMarcas" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El Nombre de la Marca del producto..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el nombre de la marca del producto...<br>
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="text" minlength="3" maxlength="20" name="TIPOMarcas" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El Tipo de producto..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                        ...
                                        <button class="btn btn-gradient-primary" type="submit"><i class="fa fa-check"></i> Registrar Marca Producto</button>
