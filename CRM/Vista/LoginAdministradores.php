                    ...
                    <div class="col-xl-7 pa-0">
                        <div class="auth-form-wrap py-xl-0 py-50">
                            <div class="auth-form w-xxl-55 w-xl-75 w-sm-90 w-xs-100">
                                <form method='POST' action='ControlLoginAdmin.php?acc=2' class="needs-validation" novalidate>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" minlength="5" maxlength="50" name="Usuario" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El Usuario..." value="" required>
                                        <!-- INVALIDO -->
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <label for="validationCustom01"></label>
                                            <input class="form-control" name="Clave" id="validationCustom01" minlength="5" maxlength="15" placeholder="Ingrese su contrase&ntilde;a..." type="password" required>
                                            <!-- INVALIDO -->
                                            <div class="invalid-feedback">
