...
<head>
    ...
    <title>..:: Sistema Gesti&oacute;n de Casos vtiger | Gestionar Ciudades ..::</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Gestionar Ciudades</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="archive"></i></span></span>Gestionar Ciudades</h4>
                </div>
                <!-- /Title -->
                                            ...
                                            <tbody>
                                                <?php 
                                                    while($filas=mysqli_fetch_array($consulta)){
                                                       ...
                                                       echo '<td><a href="cGestionarCiudades.php?acc=8&cod='.$filas['id_ciudad'].'"><i class="fa fa-edit edit-table modificar" data-toggle="tooltip-neon" data-placement="top" title="Modificar"></i></a></td>';
                                                       # CONTROL ELIMINAR REGISTROS
                                                       $ConfirmarDepuracion="return confirm('¿Desea realmente eliminar este ciudad?');";
                                                       echo '<td><a href="cGestionarCiudades.php?acc=7&cod='.$filas['id_ciudad'].'"><i class="fa fa-trash-o edit-table eliminar" data-toggle="tooltip-danger" data-placement="top" title="Eliminar" onclick="'.$ConfirmarDepuracion.'"></i></a></td>';
                                                       echo '</tr>';
                                                    }
                                                ?>
