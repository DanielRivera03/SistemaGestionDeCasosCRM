...
<head>
    ...
    <title>..:: Sistema Gesti&oacute;n de Casos vtiger | Modificar Usuarios Administradores ..::</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Modificar Usuarios Administradores</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="toggle-right"></i></span></span>Modificar Usuarios Administradores</h4>
                </div>
                <!-- /Title -->
                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form class="needs-validation" novalidate method="POST" action="../Controlador/cUsuariosAdministradores.php?acc=12" enctype="multipart/form-data">
                                        <div class="form-row">
                                            <!-- ID -->
                                            <div class="col-md-12 mb-10">
                                                
                                                <input type="hidden" name="IdAd" class="form-control" id="validationCustom01" value="<?php echo $IDAdministrador; ?>">
                                            </div>
                                            <!-- CODIGO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el c&oacute;digo del Usuario <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" minlength="5" maxlength="5" name="CodAd" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese C&oacute;digo Usuario..." data-mask="AD999" data-toggle="tooltip-pink" data-placement="top" title="Por favor respetar formato ADXXX" value="<?php echo $Usuarios->getCod(); ?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el c&oacute;digo...<br>
                                                    Car&aacute;cteres M&iacute;nimos: 4
                                                    Car&aacute;cteres M&aacute;ximos: 5
                                                </div>
                                                <!-- VALIDO -->
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="text" minlength="3" maxlength="50" name="NomAd" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese C&oacute;digo Usuario..." value="<?php echo $Usuarios->getNombreU(); ?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="password" minlength="5" maxlength="15" name="PassAd" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese Contrase&ntilde;a Usuario..." minlength="5" maxlength="15" value="<?php echo $Usuarios->getPass(); ?>" data-toggle="tooltip-pink" data-placement="top" title="M&iacute;nimo 5 caracteres" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <select class="form-control custom-select" name="EstadoAd" required>
                                                <option value="<?php echo $Usuarios->getEstados(); ?>"><?php echo $Usuarios->getEstados(); ?></option>
                                                <?php
                                                    // SI ESTADO ES ACTIVO
                                                    if($Usuarios->getEstados() == "Activo"){
                                                        echo '<option value="Inactivo">Inactivo</option>';
                                                    }
                                                    // SI ESTADO ES INACTIVO
                                                    if($Usuarios->getEstados() == "Inactivo"){
                                            ...
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <select class="form-control custom-select" name="TipoUAd" required>
