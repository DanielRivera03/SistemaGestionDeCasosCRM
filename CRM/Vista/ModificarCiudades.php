        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Modificar Ciudades</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="toggle-right"></i></span></span>Modificar Ciudades</h4>
                </div>
                <!-- /Title -->
                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form class="needs-validation" novalidate method="POST" action="../Controlador/cGestionarCiudades.php?acc=9">
                                        <div class="form-row">
                                            <!-- ID -->
                                            <div class="col-md-12 mb-10">
                                                
                                                <input type="hidden" name="IDC" class="form-control" id="validationCustom01" value="<?php echo $ID_Ciudades; ?>">
                                            </div>
                                            

                                            <!-- CODIGO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el c&oacute;digo de la ciudad <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" name="CodCiudad" class="form-control" id="validationCustom01" minlength="3" maxlength="3" placeholder="Por favor Ingrese C&oacute;digo Ciudad..." value="<?php echo $Usuarios->getCodCiudades(); ?>" required>
                                                <!-- INVALIDO -->
                                            ...
                                            <!-- NOMBRE DE CIUDAD -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el nombre de la ciudad <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" minlength="5" maxlength="50" name="NomCiudad" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El Nombre de la ciudad..." value="<?php echo $Usuarios->getNombreCiudades(); ?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                        ...
                                        <button class="btn btn-gradient-primary" type="submit"><i class="fa fa-check"></i> Modificar Ciudad</button>
                                    </form>
                                </div>
                            </div>
            </div>
