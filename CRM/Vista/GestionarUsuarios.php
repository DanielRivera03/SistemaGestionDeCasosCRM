...
<head>
    ...
    <title>..:: Sistema Gesti&oacute;n de Casos vtiger | Consulta Usuarios Administradores ..::</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="archive"></i></span></span>Gestionar Usuarios Privilegio: Empleados Administrativos</h4>
                </div>
                <!-- /Title -->
                                        ...
                                        <table id="datable_1" class="table table-hover w-100 display pb-30">
                                                ...
                                                <tbody>
                                                    ...
                                                    while($filas=mysqli_fetch_array($consulta)){
                                                       ...
                                                       echo '<td>'.$filas['contrasenia'].'</td>';
                                                       echo '<td>'.$filas['estado'].'</td>';
                                                       echo '<td><span class="badge badge-info">'.$filas['tipo_usuario'].'</span></td>';
                                                       echo '<td>'.$filas['foto_perfil'].'</td>';
                                                       echo '<td><a href="cUsuariosAdministrativos.php?acc=10&cod='.$filas['id_cliente'].'"><i class="fa fa-edit edit-table modificar" data-toggle="tooltip-neon" data-placement="top" title="Modificar"></i></a></td>';
                                                       # CONTROL ELIMINAR REGISTROS
                                                       $ConfirmarDepuracion="return confirm('¿Desea realmente eliminar este usuario?');";
                                                       echo '<td><a href="cUsuariosAdministrativos.php?acc=9&cod='.$filas['id_cliente'].'"><i class="fa fa-trash-o edit-table eliminar" data-toggle="tooltip-danger" data-placement="top" title="Eliminar" onclick="'.$ConfirmarDepuracion.'"></i></a></td>';
                                                       echo '</tr>';
                                                    }
                                                ?>
                                                </tbody>
