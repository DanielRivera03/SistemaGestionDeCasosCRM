        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="toggle-right"></i></span></span>Modificar Productos</h4>
                </div>
                <!-- /Title -->
                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form class="needs-validation" novalidate method="POST" action="../Controlador/cGestionarProductos.php?acc=9">
                                        <div class="form-row">
                                            <!-- ID -->
                                            <div class="col-md-12 mb-10">
                                                
                                                <input type="hidden" name="IDProductos" class="form-control" id="validationCustom01" value="<?php echo $ID_Productos; ?>">
                                            </div>
                                            

                                            <!-- CODIGO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el c&oacute;digo del Productos <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" name="CODIProductos" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese C&oacute;digo Productos..." maxlength="3" value="<?php echo $Usuarios->getCodProductos(); ?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el c&oacute;digo del producto...
                                                </div>
                                                <!-- VALIDO -->
                                            ...
                                            <!-- NOMBRE DE PRODUCTO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el nombre del productos <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" minlength="5" maxlength="50" name="NOMBProductos" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El Nombre del Producto..." value="<?php echo $Usuarios->getNombreProductos(); ?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el nombre del productos...<br>
                                            ...
                                            <!-- TIPO DE PRODUCTOS -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el tipo del productos <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" minlength="2" maxlength="15" name="TIPProductos" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El tipo del productos..." value="<?php echo $Usuarios->getTipoProductos(); ?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el tipo del productos...<br>
                                                    Car&aacute;cteres M&iacute;nimos: 5
                                            ...
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el Cantidad del Productos <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" minlength="1" maxlength="11" name="CANProductos" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El cantidad del productos..." value="<?php echo $Usuarios->getCantidadProductos(); ?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el cantidad del productos...<br>
                                                    Car&aacute;cteres M&iacute;nimos: 1
                                                    Car&aacute;cteres M&aacute;ximos: 11
                                                </div>
                                                <!-- VALIDO -->
                                                <div class="valid-feedback">
                                                    Campo Completado Exitosamente!...
                                            ...
                                            <!-- MARCA DE PRODUCTO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el marca del productos <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" minlength="2" maxlength="20" name="MARProductos" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese la marca de productos..." value="<?php echo $Usuarios->getMarcaProductos(); ?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese la marca de productos...<br>
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <select class="form-control custom-select" name="GARProductos" required>
                                                    <?php 
                                                        if($Usuarios->getGarantiaProductos()=="I"){
                                                            echo '<option value="I" selected>Garant&iacute;a Inactiva</option>';
                                                            echo '<option value="A">Garant&iacute;a Activa</option>';
                                                        }else if($Usuarios->getGarantiaProductos()=="A"){
                                                            echo '<option value="I">Garant&iacute;a Inactiva</option>';
                                                            echo '<option value="A" selected>Garant&iacute;a Activa</option>';
                                                        }
                                                    ?>
                                                </select>
                                                <!-- INVALIDO -->
                                        ...
                                        <button class="btn btn-gradient-primary" type="submit"><i class="fa fa-check"></i> Modificar Producto</button>
                                    </form>
                                </div>
                            </div>
            </div>
