...
<head>
    ...
    <title>..:: Sistema Gesti&oacute;n de Casos vtiger | Modificar Empresas ..::</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Modificar Empresas</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="toggle-right"></i></span></span>Modificar Empresas</h4>
                </div>
                <!-- /Title -->
                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form class="needs-validation" novalidate method="POST" action="../Controlador/cGestionarEmpresas.php?acc=9">
                                        <div class="form-row">
                                            <!-- ID -->
                                            <div class="col-md-12 mb-10">
                                                 <input type="hidden" name="IDEmpresa" class="form-control" id="validationCustom01" value="<?php echo $ID_EmpresaRegistro; ?>">     
                                            </div>


                                            <!-- CODIGO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el c&oacute;digo de Empresa <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" minlength="3" maxlength="3" name="CODEmpresa" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese C&oacute;digo de Empresa..." value="<?php echo $Usuarios->getCODEmpresa(); ?>" required>
                                                <!-- INVALIDO -->
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="text" minlength="3" maxlength="3" name="CODSUCREmpresa" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese C&oacute;digo de Sucursal..." value="<?php echo $Usuarios->getCODSucursalEmpresa(); ?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <!-- MARCAS -->
                                            <div class="col-md-12 mb-10">
                                                <label for="validationCustom01">Ingrese el rubro / marca de empresa <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" minlength="3" maxlength="50" name="NOMBMARCASEmpresa" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese el rubro / marca de empresa..." value="<?php echo $Usuarios->getMarcaEmpresa(); ?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                        ...
                                        <button class="btn btn-gradient-primary" type="submit"><i class="fa fa-check"></i> Modificar Empresa</button>
                                    </form>
                                </div>
                            </div>
            </div>
