...
<head>
    ...
    <title>..:: Sistema Gesti&oacute;n de Casos vtiger | Modificar Reportes de Problemas ..::</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item"><a href="#">Reportar Problemas</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Modificar Reporte de Problemas</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="toggle-right"></i></span></span>Modificar Reportes</h4>
                </div>
                <!-- /Title -->
                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <?php 
                                    if($Usuarios->getEstadoReportePlataforma()=="en proceso"){
                                        echo '<div class="alert alert-success alert-wth-icon alert-dismissible fade show" role="alert">
                                                <span class="alert-icon-wrap"><i class="zmdi zmdi-check-circle"></i></span> Este reporte de plataforma esta siendo gestionado por el administrador <strong>'.$Usuarios->getNombreUsuarioReportePlataforma().'</strong>
                                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>';
                                    }else if($Usuarios->getEstadoReportePlataforma()=="pendiente"){
                                        echo '<div class="alert alert-warning alert-wth-icon alert-dismissible fade show" role="alert">
                                        <span class="alert-icon-wrap"><i class="zmdi zmdi-help"></i></span> Reporte de plataforma<strong> NO TIENE NING&Uacute;N USUARIO ASIGNADO Y/O GESTION&Aacute;NDOLO</strong>.
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>';
                                    }else if($Usuarios->getEstadoReportePlataforma()=="cerrado"){
                                        echo '<div class="alert alert-danger alert-wth-icon alert-dismissible fade show" role="alert">
                                                <span class="alert-icon-wrap"><i class="zmdi zmdi-bug"></i></span> Este reporte de plataforma ha sido marcado como <strong>CERRADO</strong> por el administrador <strong>'.$Usuarios->getNombreUsuarioReportePlataforma().'</strong>.
                                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>';
                                    ...
                                    if($Usuarios->getEstadoReportePlataforma()=="Alta"){
                                    ...
                                    <form class="needs-validation" novalidate method="POST" action="../Controlador/cGestionarReportesPlataforma.php?acc=9" autocomplete="off">
                                        <div class="form-row">

                                            <?php

                                                if($Usuarios->getEstadoReportePlataforma()=="cerrado"){
                                                    // BLOQUEO TOTAL DE CONTROLES DE INGRESO DE INFORMACION {ESTADO CERRADO ESTRICTAMENTE}
                                            ?>
                                            <!-- ID REPORTE -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el Nombre del Reporte <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" name="IDReporteriaPlataforma" class="form-control prohibido" id="validationCustom01" placeholder="Por favor Ingrese el Nombre del Reporte..." value="<?php echo $ID_ReporteSistema ?>" disabled>
                                                <!-- INVALIDO -->
                                            ...
                                            <!-- CODIGO USUARIO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">C&oacute;digo &Uacute;nico de Usuario <span class="CampoObligatorio">(*)</span></label>
                                                <select name="CODReporteriaPlataforma" class="form-control prohibido" id="validationCustom01" value="" disabled>
                                                    <option value="<?php echo $Usuarios->getIDUsuarioReportePlataforma(); ?>" selected><?php echo $Usuarios->getIDUsuarioReportePlataforma(); ?></option>
                                                </select>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor Ingrese el C&oacute;digo de su Usuario...
                                                </div>
                                                <!-- VALIDO -->
                                                <div class="valid-feedback">
                                                    Campo Completado Exitosamente!...
                                            ...
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Nombre de Usuario Gestionando Reporte <span class="CampoObligatorio">(*)</span></label>
                                                <select name="NOMUSReporteriaPlataforma" class="form-control prohibido" id="validationCustom01" value="" disabled>
                                                    <option value="<?php echo $_SESSION['vsUsuario'] ?>" selected><?php echo $_SESSION['vsUsuario'] ?></option>
                                                </select>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor Ingrese el C&oacute;digo de su Usuario...
                                            ...
                                            <!-- NOMBRE DE USUARIO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Nombre de Usuario que Registro Reporte <span class="CampoObligatorio">(*)</span></label>
                                                <select name="NOMUSGSTReporteriaPlataforma" class="form-control prohibido" id="validationCustom01" value="" disabled>
                                                    <option value="<?php echo $Usuarios->getNombreUsuarioGestionReportePlataforma(); ?>" selected><?php echo $Usuarios->getNombreUsuarioGestionReportePlataforma(); ?></option>
                                                </select>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor Ingrese el C&oacute;digo de su Usuario...
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <select class="form-control custom-select prohibido" name="NIVURReporteriaPlataforma" disabled>
                                                <option selected value="<?php echo $Usuarios->getUrgenciaReportePlataforma(); ?>"><?php echo $Usuarios->getUrgenciaReportePlataforma(); ?></option>
                                                <?php
                                                    if($Usuarios->getUrgenciaReportePlataforma()=="Estandar"){
                                                        echo '<option value="Media">Media</option>';
                                                        echo '<option value="Alta">Alta</option>';
                                                    }else if($Usuarios->getUrgenciaReportePlataforma()=="Media"){
                                                        echo '<option value="Estandar">Estandar</option>';
                                                        echo '<option value="Alta">Alta</option>';
                                                    }else if($Usuarios->getUrgenciaReportePlataforma()=="Alta"){
                                                        echo '<option value="Media">Media</option>';
                                                        echo '<option value="Estandar">Estandar</option>';
                                                    }
                                                ?>
                                            ...
                                            <!-- NIVEL DE URGENCIA  -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Estado Reporte <span class="CampoObligatorio">(*)</span></label>
                                                <select class="form-control custom-select prohibido" name="ESTReporteriaPlataforma" disabled>
                                                
                                                <?php 
                                                    if($Usuarios->getEstadoReportePlataforma()=="pendiente"){
                                                    ...
                                                    }else if($Usuarios->getEstadoReportePlataforma()=="en proceso"){
                                            ...
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <textarea rows="4" name="DETAPROReporteriaPlataforma" minlength="5" maxlength="1000" class="form-control prohibido" id="validationCustom01" placeholder="Por favor Ingrese el Detalle de Problema Reporte..." value="" disabled><?php echo $Usuarios->getDetalleReportePlataforma(); ?></textarea>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <!-- COMENTARIOS PROBLEMA REPORTE -->
                                            <div class="col-md-12 mb-10">
                                                <label for="validationCustom01">Ingrese Comentarios Resoluci&oacute;n Reporte de Plataforma <span class="CampoObligatorio">(*)</span></label>
                                                <textarea rows="4" name="COMFNReporteriaPlataforma" minlength="5" maxlength="1000" class="form-control prohibido" id="validationCustom01" placeholder="Por favor Ingrese el Comentario de Resoluci&oacute;n Problema Reporte..." value="" disabled><?php echo $Usuarios->getComentariosReportePlataforma(); ?></textarea>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor Ingrese el Comentario de Resoluci&oacute;n Problema Reporte...<br>
                                                    Car&aacute;cteres M&iacute;nimos: 5
                                                    Car&aacute;cteres M&aacute;ximos: 1000
                                                </div>
                                                <!-- VALIDO -->
                                        ...
                                        <!-- MENSAJE ADVERTENCIA ESTADO CERRADO -->
                                            <div class="alert alert-danger alert-wth-icon alert-dismissible fade show" role="alert">
                                                <span class="alert-icon-wrap"><i class="zmdi zmdi-bug"></i></span> Este reporte de plataforma ha sido marcado como <strong>CERRADO</strong> por el administrador <strong><?php echo $Usuarios->getNombreUsuarioReportePlataforma(); ?></strong>.
                                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                                            <a href="../Controlador/cGestionarReportesPlataforma.php?acc=4"><button type="button" class="btn btn-gradient-danger"><i class="fa fa-check"></i> Regresar P&aacute;gina Anterior</button></a>
                                            <?php
                                            }else{
                                            ...
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el Nombre del Reporte <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" name="IDReporteriaPlataforma" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese el Nombre del Reporte..." value="<?php echo $ID_ReporteSistema ?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor Ingrese el ID del Reporte...
                                                </div>
                                            ...
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">C&oacute;digo &Uacute;nico de Usuario <span class="CampoObligatorio">(*)</span></label>
                                                <select name="CODReporteriaPlataforma" class="form-control prohibido" id="validationCustom01" value="" required>
                                                    <option value="<?php echo $Usuarios->getIDUsuarioReportePlataforma(); ?>" selected><?php echo $Usuarios->getIDUsuarioReportePlataforma(); ?></option>
                                                </select>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Nombre de Usuario Gestionando Reporte <span class="CampoObligatorio">(*)</span></label>
                                                <select name="NOMUSReporteriaPlataforma" class="form-control prohibido" id="validationCustom01" value="" required>
                                                    <option value="<?php echo $_SESSION['vsUsuario'] ?>" selected><?php echo $_SESSION['vsUsuario'] ?></option>
                                                </select>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Nombre de Usuario que Registro Reporte <span class="CampoObligatorio">(*)</span></label>
                                                <select name="NOMUSGSTReporteriaPlataforma" class="form-control prohibido" id="validationCustom01" value="" required>
                                                    <option value="<?php echo $Usuarios->getNombreUsuarioReportePlataforma(); ?>" selected><?php echo $Usuarios->getNombreUsuarioReportePlataforma(); ?></option>
                                                </select>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor Ingrese el C&oacute;digo de su Usuario...
                                            ...
                                            <div class="col-md-6 mb-12">
                                                <label for="validationCustom01">Nivel de Urgencia <span class="CampoObligatorio">(*)</span></label>
                                                <select class="form-control custom-select" name="NIVURReporteriaPlataforma" required>
                                                <option selected value="<?php echo $Usuarios->getUrgenciaReportePlataforma(); ?>"><?php echo $Usuarios->getUrgenciaReportePlataforma(); ?></option>
                                                <?php
                                                    if($Usuarios->getUrgenciaReportePlataforma()=="Estandar"){
                                                        echo '<option value="Media">Media</option>';
                                            ...
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Nivel de Urgencia <span class="CampoObligatorio">(*)</span></label>
                                                <select class="form-control custom-select" name="ESTReporteriaPlataforma" required>
                                            ...
                                            <div class="col-md-12 mb-10">
                                                <label for="validationCustom01">Ingrese el Detalle de Problema Reporte <span class="CampoObligatorio">(*)</span></label>
                                                <textarea rows="4" name="DETAPROReporteriaPlataforma" minlength="5" maxlength="1000" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese el Detalle de Problema Reporte..." value="" required><?php echo $Usuarios->getDetalleReportePlataforma(); ?></textarea>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor Ingrese el Detalle de Problema Reporte...<br>
                                                    Car&aacute;cteres M&iacute;nimos: 5
                                            ...
                                            <div class="col-md-12 mb-10">
                                                <label for="validationCustom01">Ingrese Comentarios Resoluci&oacute;n Reporte de Plataforma <span class="CampoObligatorio">(*)</span></label>
                                                <textarea rows="4" name="COMFNReporteriaPlataforma" minlength="5" maxlength="1000" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese el Comentario de Resoluci&oacute;n Problema Reporte..." value="" required><?php echo $Usuarios->getComentariosReportePlataforma(); ?></textarea>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor Ingrese el Comentario de Resoluci&oacute;n Problema Reporte...<br>
                                                    Car&aacute;cteres M&iacute;nimos: 5
                                             ...
                                             <button class="btn btn-gradient-primary" type="submit"><i class="fa fa-check"></i> Modificar Reporte de Plataforma</button>
                                            <?php
