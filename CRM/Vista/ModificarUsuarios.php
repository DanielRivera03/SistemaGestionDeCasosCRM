...
<head>
    ...
    <title>..:: Sistema Gesti&oacute;n de Casos vtiger | Modificar Usuarios Empleados ..::</title>
                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form class="needs-validation" novalidate method="POST" action="../Controlador/cUsuariosAdministrativos.php?acc=11" enctype="multipart/form-data">
                                        <div class="form-row">
                                             <!-- ID -->
                                            <div class="col-md-12 mb-10">
                                                
                                                <input type="hidden" name="IDUsuario" class="form-control" id="validationCustom01" value="<?php echo $IDEmpleados; ?>">
                                            </div>

                                            <!-- CODIGO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el c&oacute;digo del Usuario <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" minlength="1" maxlength="11" name="CodigoUsuario" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese C&oacute;digo Usuario..." data-toggle="tooltip-pink" data-placement="top" title="Solo valores n&uacute;mericos" value="<?php echo $Usuarios->getCodUsuarioGeneral(); ?>" required>
                                                <!-- INVALIDO -->
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="text" minlength="4" maxlength="25" name="NombreUsuario" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese C&oacute;digo Usuario..." value="<?php echo $Usuarios->getNombreDeUsuarioGeneral(); ?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="password" minlength="5" maxlength="15" name="PassUsuario" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese Contrase&ntilde;a Usuario..." minlength="5" maxlength="15" value="<?php echo $Usuarios->getContraseniaDeUsuarioGeneral(); ?>" data-toggle="tooltip-pink" data-placement="top" title="M&iacute;nimo 5 caracteres" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <option value="<?php echo $Usuarios->getEstadoDeUsuarioGeneral(); ?>" selected><?php echo $Usuarios->getEstadoDeUsuarioGeneral(); ?></option>
                                                <?php
                                                    // SI ESTADO ES ACTIVO
                                                    if($Usuarios->getEstadoDeUsuarioGeneral() == "Activo"){
                                                        echo '<option value="Inactivo">Inactivo</option>';
                                                    }
                                                    // SI ESTADO ES INACTIVO
                                                    if($Usuarios->getEstadoDeUsuarioGeneral() == "Inactivo"){
                                        ...
                                        <button class="btn btn-gradient-primary" type="submit"><i class="fa fa-check"></i> Modificar Usuario</button>
                                    </form>
                                </div>
                            </div>
            </div>
