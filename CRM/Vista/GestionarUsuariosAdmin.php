        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="archive"></i></span></span>Gestionar Usuarios Privilegio: Administradores</h4>
                </div>
                <!-- /Title -->
                                        ...
                                        <table id="datable_1" class="table table-hover w-100 display pb-30">
                                                ...
                                                <tbody>
                                                    ...
                                                    while($filas=mysqli_fetch_array($consulta)){
                                                       echo '<tr>';
                                                       echo '<td>'.$filas['cod_admin'].'</td>';
                                                       echo '<td>'.$filas['nombre_usuario'].'</td>';
                                                       echo '<td>'.$filas['contrasenia'].'</td>';
                                                       echo '<td>'.$filas['estado'].'</td>';
                                                       echo '<td><span class="badge badge-danger">'.$filas['tipo_usuario'].'</span></td>';
                                                       ...
                                                       echo '<td><a href="cUsuariosAdministradores.php?acc=11&cod='.$filas['id_admin'].'" data-toggle="tooltip-neon" data-placement="top" title="Modificar"> <i class="fa fa-edit edit-table modificar"></i></a></td>';
                                                       echo '<td><a href="cUsuariosAdministradores.php?acc=10&cod='.$filas['id_admin'].'" data-toggle="tooltip-danger" data-placement="top" title="Eliminar"> <i class="fa fa-trash-o edit-table eliminar" onclick="'.$ConfirmarDepuracion.'"></i></a></td>';
                                                       echo '</tr>';
                                                    }
                                                ?>
                                                </tbody>
