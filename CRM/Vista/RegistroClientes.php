...
<head>
    ...
    <title>..:: Sistema Gesti&oacute;n de Casos vtiger | Registro Nuevos Clientes ..::</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="toggle-right"></i></span></span>Registrar Clientes</h4>
                </div>
                <!-- /Title -->
                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form class="needs-validation" novalidate method="POST" action="../Controlador/cGestionarClientes.php?acc=3" autocomplete="off">
                                        <div class="form-row">
                                            <!-- ID -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el ID Cliente <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" name="IdClientes" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese ID Cliente..." value="" data-toggle="tooltip-pink" data-placement="top" title="Solo valores n&uacute;mericos" minlength="1" maxlength="6" required>
                                                <!-- INVALIDO -->
                                            ...
                                            <!-- CODIGO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el c&oacute;digo del Cliente <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" name="CodClientes" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese C&oacute;digo Cliente..." value="" data-toggle="tooltip-pink" data-placement="top" title="Solo valores n&uacute;mericos" minlength="1" maxlength="6" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <!-- NOMBRE DE CLIENTE -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el nombre del cliente <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" minlength="5" maxlength="50" name="NombreClientes" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El Nombre del cliente..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <!-- APELLIDO DE CLIENTE -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el apellido del cliente <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" minlength="5" maxlength="50" name="ApellidoClientes" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El Apellido del cliente..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el nombre del cliente...<br>
                                                    Car&aacute;cteres M&iacute;nimos: 5
                                            ...
                                            <!-- DUI DE CLIENTE -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el DUI del cliente <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" minlength="8" maxlength="12" name="DuiClientes" data-mask="99999999-9" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El Dui del cliente..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <!-- TELEFONO DE CLIENTE -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el tel&eacute;fono del cliente <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" minlength="8" maxlength="9" name="TelClientes" data-mask="9999-9999" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El Tel&eacute;fono del cliente..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <!-- CIUDAD DE CLIENTE -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese la ciudad de residencia del cliente <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" minlength="7" maxlength="100" name="CiudadClientes" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese La Ciudad de Residencia del cliente..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese la direcci&oacute;n del cliente <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" minlength="7" maxlength="100" name="DirClientes" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese La Direcci&oacute;n de Residencia del cliente..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el nombre del cliente...<br>
                                                    Car&aacute;cteres M&iacute;nimos: 7
                                            ...
                                            <!-- CORREO DE CLIENTE -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el correo del cliente <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="email" name="CorreoClientes" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El Correo del cliente..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <!-- ESTADO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Estado del Cliente <span class="CampoObligatorio">(*)</span></label></label>
                                            ...
                                            <div class="col-md-12 mb-10">
                                                <label for="validationCustom01">Estado De Factura Cliente <span class="CampoObligatorio">(*)</span></label></label>
                                        ...
                                        <button class="btn btn-gradient-primary" type="submit"><i class="fa fa-check"></i> Registrar Cliente</button>
