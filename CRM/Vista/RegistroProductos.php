...
<head>
    ...
    <title>..:: Sistema Gesti&oacute;n de Casos vtiger | Registro Productos ..::</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="toggle-right"></i></span></span>Registrar Productos</h4>
                </div>
                <!-- /Title -->
                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form class="needs-validation" novalidate method="POST" action="../Controlador/cGestionarProductos.php?acc=3" autocomplete="off">
                                        <div class="form-row">
                                            <!-- ID -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el ID Producto <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" name="IDProductos" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese ID Producto..." value="" data-toggle="tooltip-pink" data-placement="top" title="Solo valores n&uacute;mericos" minlength="1" maxlength="6" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el ID Producto...
                                                </div>
                                                <!-- VALIDO -->
                                            ...
                                            <!-- CODIGO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el c&oacute;digo de producto <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" minlength="3" maxlength="3" name="CODIProductos" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese C&oacute;digo Producto..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el c&oacute;digo de producto...<br>
                                            ...
                                            <!-- NOMBRE DE PRODUCTO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el nombre del producto <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" minlength="4" maxlength="50" name="NOMBProductos" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El Nombre del producto..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el nombre del producto...<br>
                                                    Car&aacute;cteres M&iacute;nimos: 4
                                            ...
                                            <!-- TIPO DE PRODUCTO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el tipo de producto <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" minlength="3" maxlength="15" name="TIPProductos" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El Tipo de producto..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el tipo de producto...<br>
                                                    Car&aacute;cteres M&iacute;nimos: 3
                                            ...
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese la cantidad de productos <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" name="CANProductos" class="form-control" id="validationCustom01" placeholder="Por favor La Cantidad de Productos..." value="" data-toggle="tooltip-pink" data-placement="top" title="Solo valores n&uacute;mericos" minlength="1" maxlength="11" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese cantidad de productos...
                                                </div>
                                                <!-- VALIDO -->
                                                <div class="valid-feedback">
                                                    Campo Completado Exitosamente!...
                                            ...
                                            <!-- MARCA DE PRODUCTO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese la Marca de producto <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" minlength="2" maxlength="20" name="MARProductos" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese La Marca de Producto..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese la marca de producto...<br>
                                                    Car&aacute;cteres M&iacute;nimos: 2
                                                    Car&aacute;cteres M&aacute;ximos: 20
                                                </div>
                                                <!-- VALIDO -->
                                                <div class="valid-feedback">
                                                    Campo Completado Exitosamente!...
                                            ...
                                            <div class="col-md-12 mb-10">
                                                <label for="validationCustom01">Ingrese la clave de garant&iacute;a <span class="CampoObligatorio">(*)</span></label></label>
                                                <select class="form-control custom-select" name="GARProductos" required>
                                                    <option value="">Seleccione un estado...</option>
                                                    <option value="A">Garant&iacute;a Activa</option>
                                                    <option value="I">Garant&iacute;a Inactiva</option>
                                                </select>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por Favor Ingrese la clave de garant&iacute;a...<br>
                                                    Car&aacute;cteres M&iacute;nimos: 1
                                                    Car&aacute;cteres M&aacute;ximos: 1
                                                </div>
                                                <!-- VALIDO -->
                                                <div class="valid-feedback">
                                                    Campo Completado Exitosamente!...
                                        ...
                                        <button class="btn btn-gradient-primary" type="submit"><i class="fa fa-check"></i> Registrar Producto</button>
