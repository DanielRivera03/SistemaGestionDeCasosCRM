...
<head>
    ...
    <title>..:: Sistema Gesti&oacute;n de Casos vtiger | Registro Ciudades ..::</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Registrar Ciudades</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="toggle-right"></i></span></span>Registrar Ciudades</h4>
                </div>
                <!-- /Title -->
                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form class="needs-validation" novalidate method="POST" action="../Controlador/cGestionarCiudades.php?acc=3" autocomplete="off">
                                        <div class="form-row">
                                            <!-- ID -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el ID Ciudad <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" name="IdCiudad" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese ID Ciudad..." value="" data-toggle="tooltip-pink" data-placement="top" title="Solo valores n&uacute;mericos" minlength="1" maxlength="6" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el ID Ciudad...
                                                </div>
                                                <!-- VALIDO -->
                                            ...
                                            <!-- CODIGO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el c&oacute;digo de ciudad <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" minlength="3" maxlength="3" name="CodCiudad" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese C&oacute;digo Ciudad..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el c&oacute;digo de ciudad...<br>
                                                    Car&aacute;cteres M&iacute;nimos: 3
                                                    Car&aacute;cteres M&iacute;ximos: 3
                                                </div>
                                                <!-- VALIDO -->
                                                <div class="valid-feedback">
                                                    Campo Completado Exitosamente!...
                                            ...
                                            <div class="col-md-12 mb-10">
                                                <label for="validationCustom01">Ingrese el nombre de la ciudad <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" minlength="3" maxlength="50" name="NomCiudad" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El Nombre de la Ciudad..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el nombre de la ciudad...<br>
                                                    Car&aacute;cteres M&iacute;nimos: 3
                                                    Car&aacute;cteres M&iacute;ximos: 50
                                                </div>
                                                <!-- VALIDO -->
                                                <div class="valid-feedback">
                                                    Campo Completado Exitosamente!...
                                        ...
                                        <button class="btn btn-gradient-primary" type="submit"><i class="fa fa-check"></i> Registrar Ciudad</button>
