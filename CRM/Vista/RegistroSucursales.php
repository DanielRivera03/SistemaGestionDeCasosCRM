...
<head>
    ...
    <title>..:: Sistema Gesti&oacute;n de Casos vtiger | Registro Sucursales ..::</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Registrar Sucursales</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="toggle-right"></i></span></span>Registrar Sucursales</h4>
                </div>
                <!-- /Title -->
                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form class="needs-validation" novalidate method="POST" action="../Controlador/cGestionarSucursales.php?acc=3" autocomplete="off">
                                        <div class="form-row">
                                            <!-- ID -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el ID Sucursal</label>
                                                <input type="text" name="IDSucursales" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese ID Sucursal..." value="" data-toggle="tooltip-pink" data-placement="top" title="Solo valores n&uacute;mericos" minlength="1" maxlength="6" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el ID Sucursal...
                                                </div>
                                                <!-- VALIDO -->
                                            ...
                                            <!-- CODIGO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el c&oacute;digo de sucursal</label>
                                                <input type="text" name="CODISucursales" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese C&oacute;digo Sucursal..." value="" data-toggle="tooltip-pink" data-placement="top" title="Solo valores n&uacute;mericos" minlength="1" maxlength="6" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el c&oacute;digo de sucursal...
                                                </div>
                                                <!-- VALIDO -->
                                                <div class="valid-feedback">
                                                    Campo Completado Exitosamente!...
                                            ...
                                            <!-- NOMBRE DE SUCURSAL -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el nombre de sucursal</label>
                                                <input type="text" minlength="4" maxlength="50" name="NOMBRSucursales" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El Nombre de sucursal..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el nombre del sucursal...<br>
                                            ...
                                            <!-- TELEFONO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el tel&eacute;fono de sucursal</label>
                                                <input type="text" minlength="8" maxlength="9" name="TELESucursales" data-mask="9999-9999" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El Tel&eacute;fono de sucursal..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el tel&eacute;fono de sucursal...<br>
                                            ...
                                            <!-- DIRECCION -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese direcci&oacute;n de sucursal</label>
                                                <input type="text" minlength="5" maxlength="50" name="DIRESucursales" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese direcci&oacute;n de sucursal..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese la direcci&oacute;n de sucursal...<br>
                                            ...
                                            <!-- CORREO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el Correo de Sucursal</label>
                                                <input type="email" minlength="5" maxlength="50" name="CORRSucursales" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese El Correo de Sucursal..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el correo de sucursal...<br>
                                                    Car&aacute;cteres M&iacute;nimos: 5
                                                    Car&aacute;cteres M&aacute;ximos: 50
                                                </div>
                                                <!-- VALIDO -->
                                        ...
                                        <button class="btn btn-gradient-primary" type="submit"><i class="fa fa-check"></i> Registrar Sucursal</button>
