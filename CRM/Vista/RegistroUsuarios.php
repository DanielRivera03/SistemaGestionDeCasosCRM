...
<head>
    ...
    <title>..:: Sistema Gesti&oacute;n de Casos vtiger | Registro Nuevos Usuarios ..::</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="toggle-right"></i></span></span>Registrar Usuarios</h4>
                </div>
                <!-- /Title -->
                        ...
                        <section class="hk-sec-wrapper">
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form class="needs-validation" novalidate method="POST" action="../Controlador/cUsuariosAdministrativos.php?acc=3" enctype="multipart/form-data" autocomplete="off">
                                        <div class="form-row">
                                            <!-- ID -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el ID de Usuario <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" minlength="1" maxlength="11" name="IDUsuario" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese el ID de Usuario..." value="" data-toggle="tooltip-pink" data-placement="top" title="Solo valores n&uacute;mericos" minlength="1" maxlength="6" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor Ingrese El ID de Usuario...
                                                <!-- VALIDO -->
                                            ...
                                            <!-- CODIGO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el c&oacute;digo del Usuario <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" minlength="1" maxlength="11" name="CodigoUsuario" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese C&oacute;digo Usuario..." value="" data-toggle="tooltip-pink" data-placement="top" title="Solo valores n&uacute;mericos" minlength="1" maxlength="6" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <!-- NOMBRE USUARIO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el nombre de Usuario <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" minlength="4" maxlength="25" name="NombreUsuario" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese C&oacute;digo Usuario..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el nombre de usuario...<br>
                                                    Car&aacute;cteres M&iacute;nimos: 4
                                                    Car&aacute;cteres M&aacute;ximos: 25
                                                </div>
                                                <!-- VALIDO -->
                                                <div class="valid-feedback">
                                                    Campo Completado Exitosamente!...
                                            ...
                                            <!-- CONTRASEÑA -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese la contrase&ntilde;a <span class="CampoObligatorio">(*)</span></label>
                                                <input type="password" minlength="5" maxlength="15" name="PassUsuario" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese Contrase&ntilde;a Usuario..." minlength="5" maxlength="15" value="" data-toggle="tooltip-pink" data-placement="top" title="M&iacute;nimo 5 caracteres" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <!-- ESTADO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Estado Usuario <span class="CampoObligatorio">(*)</span></label>
                                                <select class="form-control custom-select" name="EstadoUsuario" required>
                                            ...
                                            <!-- TIPO USUARIO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Tipo de Usuario <span class="CampoObligatorio">(*)</span></label>
                                                <select class="form-control custom-select" name="TipoUsuario" required>
                                                <option value="">Seleccione un estado...</option>
                                            ...
                                            <div class="col-md-12 mb-10">
                                                <label for="validationCustom01">Ingrese su foto de perfil <span class="CampoObligatorio">(*)</span></label>
                                                <input type="file" id="input-file-now" name="FotoPerfilEmpleados" class="form-control dropify"  data-max-file-size="2M" accept="image/x-png,image/jpeg" data-toggle="tooltip-pink" data-placement="top" title="Campo Obligatorio" required>
                                        ...
                                        <button class="btn btn-gradient-primary" type="submit"><i class="fa fa-check"></i> Registrar Usuario</button>
